...
BUILD_SETTINGS = BazelBuildSettings(
    '/Users/dmitry/.bazel/bin/bazel',
    '/private/var/tmp/_bazel_dmitry/02a2e3662efe5f9742ce3f7bf49d4039/execroot/mediapipe',
    'ios_x86_64',
    {
        'ios_arm64e': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/dmitry/Library/Application Support/Tulsi/0.20190814.88/Bazel',
